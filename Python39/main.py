...
print(name)
#dis4=m.eucaldainDistance(PointList[51], PointList[57])
...
while True:
    ...
    if face is not None:
        ...
        #          m.fonts, 0.6, leftColor[1], 2)
        #########################################################################################################
        # midp=m.midpoint(PointList[51], PointList[57]);
        # d1= m.eucaldainDistance(midp,PointList[51])/dis
        # d2=m.eucaldainDistance(midp,PointList[57])/dis
        # print(d1)
        # print(d2)
